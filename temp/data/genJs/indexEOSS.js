...
$( "#personsList" ).html( "<li>Person <b>Andrew Perkins</b> is  <span>25</span> years old.  can Drive  <a href=\"\" data-id=\"0\" data-event=\"Event: 'onclick', Action: 'deleteThePerson'\">X</a></li><li>Person <b>John Doe</b> is  <span>43</span> years old.  can Drive  <a href=\"\" data-id=\"1\" data-event=\"Event: 'onclick', Action: 'deleteThePerson'\">X</a></li><li>Person <b>Some Person</b> is  <span>32</span> years old.  can Drive  <a href=\"\" data-id=\"2\" data-event=\"Event: 'onclick', Action: 'deleteThePerson'\">X</a></li>" )
.attr("data-collection", '[{"id":0,"name":"Andrew Perkins","age":25},{"id":1,"name":"John Doe","age":43},{"id":2,"name":"Some Person","age":32}]');



$( "#personsSelect" ).html( "<option>Andrew Perkins - 25</option><option>John Doe - 43</option><option>Some Person - 32</option>" )
.attr("data-collection", '[{"id":0,"name":"Andrew Perkins","age":25},{"id":1,"name":"John Doe","age":43},{"id":2,"name":"Some Person","age":32}]');
